...
module.exports.config = {
  ...
  version: "1.0.1",
  hasPermssion: 0,
  credits: "𝐒𝐈𝐙𝐔𝐊𝐀 ☢️_𖣘 -𝐁𝐎𝐓 ⚠️ 𝑻𝑬𝑨𝑴_ ☢️",
  description: "goibot",
...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "help") || (event.body.toLowerCase() == "help")) {
     rউল্n api.sendMessage("type /help", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "ayan") || (event.body.toLowerCase() == "ayan vai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
